...
-- 2. Add new fields to school_xx_staff table for leave/salary configuration
-- 3. Add new fields to school_xx_salary_payments table for leave tracking and allowances
-- ============================================
...
FROM school_xx_roles r
WHERE r.name IN ('Admin', 'Manager', 'Super Admin')
ON CONFLICT DO NOTHING;

-- 3. Add new fields to school_xx_staff table
...
-- 4. Add new fields to school_xx_salary_payments table
...
UPDATE school_xx_salary_payments
