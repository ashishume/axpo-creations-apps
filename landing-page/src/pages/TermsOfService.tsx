      ...
      <main className="flex-grow">
        <div className="max-w-[720px] mx-auto px-4 py-8">
          ...
          <p className="text-slate-600 dark:text-slate-400 mb-4">
            ...
            you paid (for example cash, UPI, bank transfer, or a labeled card
            entry with{" "}
            <strong className="dark:text-slate-300 text-slate-700">
              last four digits only
            </strong>
            ) to organize and filter your records. The app does{" "}
            <strong className="dark:text-slate-300 text-slate-700">not</strong>{" "}
            process payments to merchants or other people and is{" "}
            <strong className="dark:text-slate-300 text-slate-700">not</strong> a
            bank or payment network. The service is provided &quot;as is&quot; and
            we reserve the right to change, suspend, or discontinue features at
            any time.
          </p>
          ...
          <p className="text-slate-600 dark:text-slate-400 mb-4">
            You sign in using your Google account (or other sign-in options we
            may offer). You must be at least 13 years old (or the minimum age in
            your country to use such services) and able to form a binding
            contract. You are responsible for keeping your account secure and for
          ...
          <ul className="list-disc pl-5 space-y-2 text-slate-600 dark:text-slate-400 mb-4">
            ...
            <li>
              Upload malicious code or abuse the app in a way that harms others
              or the service.
            </li>
            <li>
            ...
            <li>
              ...
              ,{" "}
              <strong className="dark:text-slate-300 text-slate-700">PINs</strong>
              , or other payment authentication data in any field. The app is
              intended for non-sensitive labels and card{" "}
              <strong className="dark:text-slate-300 text-slate-700">
                last four digits
              </strong>{" "}
              only.
          ...
          <h2 className="text-lg font-medium mt-8 mb-2 dark:text-slate-200 text-slate-900">
            5. Optional Payment Method Labels
          </h2>
          <p className="text-slate-600 dark:text-slate-400 mb-4">
            ...
            substitute for your obligations to banks or card issuers.
          </p>
          ...
          <p className="text-slate-600 dark:text-slate-400 mb-4">
            ...
            , which describes what data we collect and how we use it. By using
            the app, you consent to that processing.
          </p>
          ...
          <ul className="list-disc pl-5 space-y-2 text-slate-600 dark:text-slate-400 mb-4">
            <li>
              ...
              The subscription is auto-renewable. The subscription name, length
              (e.g. monthly), and price are shown in the app at the time of
              purchase and in the App Store or Google Play (or equivalent store)
              product page.
            </li>
            <li>
              <strong className="dark:text-slate-300 text-slate-700">
              ...
              Payment is processed by Apple (on iOS), Google Play (on Android),
              or the applicable platform. We do not store your payment card
              details for those purchases.
            </li>
            <li>
              <strong className="dark:text-slate-300 text-slate-700">
                Renewal and cancellation:
              </strong>{" "}
              Your subscription will renew automatically unless you turn off
              auto-renewal at least 24 hours before the end of the current
              period. You can manage or cancel your subscription in your
              device&apos;s account settings (e.g. iOS: Settings → [Your Name] →
              Subscriptions).
            </li>
            <li>
              <strong className="dark:text-slate-300 text-slate-700">
              ...
              Refund requests for purchases made through the App Store, Google
              Play, or other platforms are subject to that platform&apos;s refund
              policy. We cannot issue refunds directly for those purchases.
            </li>
          </ul>
          ...
          <p className="text-slate-600 dark:text-slate-400 mb-4">
            The app, its design, branding, and content (other than
            user-generated content) are owned by us or our licensors. You may not
            copy, modify, or create derivative works of the app or its branding
            without permission. You retain ownership of the data you input; you
            grant us the rights needed to operate the service (e.g. store and
            sync your data).
          </p>
          ...
          <p className="text-slate-600 dark:text-slate-400 mb-4">
            ...
            PROFITS, DATA, OR USE, ARISING FROM OR RELATED TO YOUR USE OF THE
            APP. OUR TOTAL LIABILITY FOR ANY CLAIMS RELATED TO THE SERVICE SHALL
            NOT EXCEED THE AMOUNT YOU PAID US IN THE PAST 12 MONTHS (OR, IF
            NOTHING, ONE HUNDRED US DOLLARS).
          </p>
