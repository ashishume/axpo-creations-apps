...
class StockService:
    ...
    async def list_by_organization(self, db: AsyncSession, organization_id: UUID) -> list[Stock]:
        return await stock_repository.list_by_organization(db, organization_id)
    ...
    async def list_by_session_paginated(
        ...
        *,
        ...
        total = await stock_repository.count_by_session(db, session_id)
        items = await stock_repository.list_by_session_paginated(
    ...
    async def list_by_organization_paginated(
        ...
        *,
        ...
        total = await stock_repository.count_by_organization(db, organization_id)
        items = await stock_repository.list_by_organization_paginated(
